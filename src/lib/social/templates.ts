...
export const TEMPLATES: TemplateDef[] = [
  {
    ...
    build: (format, seed) => {
      ...
      return {
        ...
        elements: [
          text('hue&heal.', { x: 8, y: 6, w: 40, h: 8 }, { color: CREAM, fontKey: 'serif', fontSize: 34, fontWeight: 300 }, { role: 'wordmark' }),
          ...
          text('Designing the future of wellness', { x: 8, y: 92, w: 70, h: 6 }, { color: CREAM, fontKey: 'voice', fontSize: 30, italic: true, opacity: 0.85 }, { role: 'tagline' }),
        ],
      }
    },
  },
  {
    ...
    build: (_format, seed) => {
      ...
      return {
        ...
        elements: [
          text('hue&heal.', { x: 8, y: 7, w: 40, h: 8 }, { color: INK, fontKey: 'serif', fontSize: 34, fontWeight: 300 }, { role: 'wordmark' }),
          ...
          text('— Hue & Heal', { x: 9, y: 86, w: 60, h: 6 }, { color: '#6E6456', fontKey: 'sans', fontSize: 24, letterSpacing: 0.04 }, { role: 'tagline' }),
        ],
      }
    },
  },
  {
    ...
    build: (format, seed) => {
      ...
      return {
        ...
        background: { type: 'atmos', value: 'atmos' },
        elements: [
          text('hue&heal.', { x: 8, y: 7, w: 40, h: 8 }, { color: CREAM, fontKey: 'serif', fontSize: 34, fontWeight: 300 }, { role: 'wordmark' }),
...
TEMPLATES.push({
  ...
  build: (format, seed) => {
    ...
    return {
      ...
      scrimStrength: 72,
      elements: [
        text("hue&heal’s guide to", { x: 8, y: 8, w: 84, h: 6 }, { color: CREAM, fontKey: 'serif', fontSize: 30, align: 'center', letterSpacing: 0.02 }, { role: 'eyebrow' }),
